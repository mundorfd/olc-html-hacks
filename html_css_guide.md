...
3. The `margin` property will set a margin area on the top, right, bottom and left (in that order). So 0 on the top, 0 on the right, 10 pixels on the bottom, and 30 pixels on the left. This would have the same effect as setting each up manually, like this: `margin-bottom: 10px; margin-left: 10px;`
